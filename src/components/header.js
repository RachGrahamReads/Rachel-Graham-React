  ...
  return (
    ...
    >
      <header data-thq="thq-navbar" className="header-navbar-interactive">
        <img
          alt={props.headerNameHandwrittenAlt}
          src={props.headerNameHandwrittenSrc}
          className="header-header-name-handwritten"
        />
        <div data-thq="thq-navbar-nav" className="header-desktop-menu">
          <nav className="header-links">
            ...
            <Link to="/books" className="header-books">
              {props.books}
            </Link>
        ...
        <div data-thq="thq-mobile-menu" className="header-mobile-menu">
          <div className="header-nav">
            ...
            <nav className="header-links1">
              ...
              <Link to="/books" className="header-books1">
                {props.books1}
              </Link>
              <Link to="/contact" className="header-contact1">
                {props.contact1}
              </Link>
            </nav>
          </div>
...
Header.defaultProps = {
  text: 'About',
  headerNameHandwrittenSrc: '/rachelgrahamhandwritten-500w.png',
  headerNameHandwrittenAlt: 'image',
  books1: 'Books',
  contact: 'Contact',
  about: 'About',
  rootClassName: '',
...
Header.propTypes = {
  ...
  headerNameHandwrittenSrc: PropTypes.string,
  headerNameHandwrittenAlt: PropTypes.string,
  books1: PropTypes.string,
  contact: PropTypes.string,
  about: PropTypes.string,
  rootClassName: PropTypes.string,
  books: PropTypes.string,
  linkIconTwitter: PropTypes.string,
  contact1: PropTypes.string,
  home: PropTypes.string,
  home1: PropTypes.string,
  linkIconInsta: PropTypes.string,
  linkIconFB: PropTypes.string,
}
