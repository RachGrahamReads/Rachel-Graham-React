...
const Books = (props) => {
  return (
    <div className="books-container">
      ...
      <div id="Home" className="books-top-container">
        <div className="books-title-name-container">
          <h2 className="books-check-out-our">CHECK OUT MY</h2>
          <h1 className="books-latest-reads">LATEST READS</h1>
        </div>
      </div>
      <div id="Latest-Listing" className="books-white-banner">
        <div className="books-white-banner-container">
          <h1 className="books-text">FOLLOW ME</h1>
          <span className="books-coming-soon">COMING SOON</span>
          <span>
            <span>
          ...
          <a href="#Subscribe" className="books-button button">
            Keep me updated
          </a>
        </div>
        <img
      ...
      <div id="Coming-Soon" className="books-features">
        <h1 className="books-latest-reads1">COMING SOON</h1>
      ...
      <div id="Subscribe" className="books-contact">
        <h1 className="books-text05">STAY UP TO DATE</h1>
        <span className="books-text06">
        ...
        <form className="books-form">
          <input
            ...
            className="books-name input"
          />
          <input
            type="text"
            required="true"
            placeholder="Your email"
            className="books-email input"
          />
          <button className="books-button1 button">Subscribe</button>
        </form>
      </div>
      <div id="Footer" className="books-footer">
        <div className="books-container2">
          <div className="books-container3">
            <span className="books-text07">
              <span>© 2024 by Rachel Graham</span>
              <br></br>
            </span>
            <span className="books-text10">
              Find me everywhere @rachgrahamreads
            </span>
            <div className="books-icons-container">
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="books-link1"
              >
                <svg
                  viewBox="0 0 602.2582857142856 1024"
                  className="books-icon2"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="books-link2"
              >
                <svg
                  viewBox="0 0 950.8571428571428 1024"
                  className="books-icon4"
                >
