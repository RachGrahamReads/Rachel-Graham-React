...
const About = (props) => {
  return (
    <div className="about-container">
      ...
      <div id="Home" className="about-top-container">
        <div className="about-title-name-container">
          <h2 className="about-check-out-our">A LITTLE BIT</h2>
          <h1 className="about-latest-reads">ABOUT ME</h1>
        </div>
      </div>
      <div id="Latest-Listing" className="about-white-banner">
        <div className="about-white-banner-container">
          <h1 className="about-text">WELL, HOWDY!</h1>
          <span className="about-coming-soon">
            HELLO FROM LITTLE OL&apos; NEW ZEALAND
          </span>
          <span>I&apos;m a mental health nurse from New Zealand.</span>
        </div>
      </div>
      <div id="Subscribe" className="about-contact">
        <h1 className="about-text1">STAY UP TO DATE</h1>
        ...
        <form className="about-form">
          ...
          />
          <button className="about-button button">Subscribe</button>
        </form>
      </div>
